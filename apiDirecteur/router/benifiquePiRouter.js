...
const Benifique = require('../model/benifiquePiModel');
...
router.post('/ajouter',verifyToken,async(req,res)=>{
    try{
        ...
        newBenifique.travail=req.body.travail ;
        newBenifique.tel=req.body.tel ;
        newBenifique.dette=req.body.dette ;
        ...
        newBenifique.numBranch=req.body.numBranch ;
        newBenifique.nature=req.body.nature ;
